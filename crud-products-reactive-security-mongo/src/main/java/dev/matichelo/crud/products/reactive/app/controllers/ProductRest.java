 ...
 */
    ...
    public ResponseEntity<Mono<Product>> productById(@PathVariable String codProduct){
    ...
    public Mono<ResponseEntity<Product>> updatePrice(@PathVariable String codProduct, @PathVariable double price){
    ...
    public Mono<ResponseEntity<Product>> deleteProduct(@PathVariable String codProduct){
